...
<html>
  ...
  <head>
    <title>Welcome to the installation wizard | Toodler Coders</title>
    <meta charset="utf-8">
  ...
  <body class="auth-wrapper login" style="background: url('public/uploads/bglogin.jpg');background-size: cover;background-repeat: no-repeat;">
      <div class="auth-box-w wider">
        <div class="logo-wy">
          <a href="<?php echo base_url();?>"><img alt="" src="public/uploads/coder.png" width="35%"></a>
        </div>
          ...
          <div class="steps-w">
            ...
            <div class="step-contents">
                <div class="step-content active" id="stepContent1">
                  <div class="row">
                  <h5 class="form-header">Welcome to Toodler Coders Installation Wizard!</h5>
                  <h4>Thanks for Using Toodler Coders</h4>
				  <h3>Requirements PHP Version 7.4 Minimum (without this you will get 500 Error)</h3>
                  <?php
                    session_start();
                    if($_SESSION['error'] == '1'):?>
                  ...
                  <legend><span>Verify Toodler Coders (As it should not use for malpractice!)</span></legend>
                      <div class="col-sm-6">
                        <div class="form-group">
                            <label for=""> Username*</label>
                            <input class="form-control" placeholder="Toodler Username" required="" name="code_username" type="text">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                            <label for="">Purchase Code*</label>
                            <input class="form-control" placeholder="Toodler Code" name="purchase_code" required="" required type="text">
                        </div>
                      </div>
                  </div>
              ...
              <legend><span>System Settings</span></legend>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="Eg: Toodler Coders" name="system_name" required type="text">
                    </div>
                  </div>
                  <div class="form-group col-sm-6">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="Eg: Toodler Coders" name="system_title" required type="text">
                    </div>
                  </div>
                  <div class="form-group col-sm-6">
